...
export default function AdminDashboard() {
  ...
  return <main className="min-h-screen bg-[#07111f] p-4 text-slate-100 md:p-8"><div className="mx-auto max-w-7xl"><header className="flex flex-col gap-4 border-b border-slate-800 pb-6 md:flex-row md:items-center md:justify-between"><div><p className="text-sm font-bold tracking-[.24em] text-violet-300">OLLAMA GATEWAY</p><h1 className="mt-1 text-3xl font-bold">Administration</h1><p className="mt-1 text-sm text-slate-400">Usage intelligence and API access control</p></div><div className="flex items-center gap-3"><div className="hidden text-right text-xs text-slate-400 md:block"><p>{user.email}</p><p className="text-violet-300">Administrator</p></div><button onClick={loadDashboard} className="rounded-md bg-violet-500 px-4 py-2 text-sm font-semibold text-white">Refresh</button><button onClick={logout} className="rounded-md border border-slate-700 px-4 py-2 text-sm">Sign out</button></div></header><nav className="mt-5 flex gap-2 overflow-auto border-b border-slate-800 pb-3"><Link href="/" className="rounded-md bg-violet-500 px-4 py-2 text-sm font-semibold text-white">Overview</Link><Link href="/analytics" className="rounded-md px-4 py-2 text-sm text-slate-300 hover:bg-slate-800">Analytics</Link><a href="#api-keys" className="rounded-md px-4 py-2 text-sm text-slate-300 hover:bg-slate-800">API keys</a><Link href="/documentation" className="rounded-md px-4 py-2 text-sm text-slate-300 hover:bg-slate-800">Documentation</Link><Link href="/chat" className="rounded-md px-4 py-2 text-sm text-cyan-300 hover:bg-slate-800">Open chat</Link></nav>
