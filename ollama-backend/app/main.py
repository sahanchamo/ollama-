...
async def lifespan(app: FastAPI):
    ...
    async with engine.begin() as connection:
        ...
        await connection.execute(text("ALTER TABLE messages ADD COLUMN IF NOT EXISTS images JSONB NOT NULL DEFAULT '[]'::jsonb"))
        await connection.execute(text("ALTER TABLE skill_sets ADD COLUMN IF NOT EXISTS admin_only BOOLEAN NOT NULL DEFAULT false"))
